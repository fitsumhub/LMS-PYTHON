...
class login:
    def __init__(self, window):
        ...
        self.frame = Frame(self.window, bg='lightblue', width=700, height=400)  # creating frame

    def loginfn(self):
        self.label = Label(self.frame, text='Log In', bg='lightblue', font=('Georgia', 36, 'bold'))

        self.name = Label(self.frame, text='Enter User_Name: ', bg='lightblue', font=('Arial', 18, 'bold'))

        self.namee_text = StringVar()
        self.namee = Entry(self.frame, textvariable=self.namee_text, fg='gray', width=25, font=('Arial', 16, 'bold'))

        self.password1 = Label(self.frame, text='Enter Password : ', bg='lightblue', fg='Green', font=('Arial', 18, 'bold'))
        ...
        if self.flag != 0:
            self.buttonAdmin = Button(self.frame, text='Admin', bg='lightblue', fg='gray12', font=('Georgia', 18, 'bold'),
                                      cursor='hand2', command=self.adminbutton2)
        else:
            self.buttonAdmin = Button(self.frame, text='Admin', bg='lightblue', fg='gray12', font=('Georgia', 18, 'bold'),
                                      cursor='hand2', command=self.adminbutton)

        self.buttonStudent = Button(self.frame, text='Student', bg='lightblue', fg='gray12', font=('Georgia', 18, 'bold'),
                                    cursor='hand2', command=self.studentbutton)
    ...
    def register(self):
        ...
        self.labelr = Label(self.frame, text='Register', bg='lightblue', font=('Georgia', 32, 'bold'))

        self.namer = Label(self.frame, text='Name : ', bg='lightblue', font=('Arial', 14, 'bold'))

        self.namere_text = StringVar()
        self.namere = Entry(self.frame, textvariable=self.namere_text, fg='gray')

        self.idr = Label(self.frame, text='Roll No. : ', bg='lightblue', font=('Arial', 14, 'bold'))

        self.rollno_text = StringVar()
        self.idre = Entry(self.frame, textvariable=self.rollno_text, fg='gray', width=25, font=('Arial', 12, 'bold'))

        self.passwordr1 = Label(self.frame, text='Create Password : ', bg='lightblue', fg='Green', font=('Arial', 14, 'bold'))

        self.passwordr1e_text = StringVar()
        self.passwordr1e = Entry(self.frame, textvariable=self.passwordr1e_text, bg='White', fg='gray', width=25,
                                  font=('Arial', 12, 'bold'), show='*')

        self.passwordr2e_text = StringVar()
        self.passwordr2 = Label(self.frame, text='Reenter Password : ', bg='lightblue', fg='Green', font=('Arial', 14, 'bold'))

        self.passwordr2e = Entry(self.frame, bg='White', fg='gray', width=25, font=('Arial', 12, 'bold'), show='*')

        self.buttonr = Button(self.frame, text='Register', bg='gray', fg='gray12', font=('Georgia', 14, 'bold'),
                              cursor='hand2', command=self.create)

        self.buttonr2 = Button(self.frame, text='Back', bg='gray', fg='gray12', font=('Georgia', 14, 'bold'),
    ...
    def studentbutton(self):
        ...
        self.buttonlogin.destroy()
        self.buttonlogin = Button(self.frame, text='LOG IN', bg='gray', fg='gray12', font=('Georgia', 18, 'bold'),
                                  cursor='hand2', command=self.login_student)
        self.buttonlogin.place(x=180, y=300, width=140, height=50)

        self.name = Label(self.frame, text='Enter Name: ', bg='lightblue', font=('Arial', 18, 'bold'))
        self.name.place(x=100, y=140, width=240, height=60)
        self.button2 = Button(self.frame, text='SIGN UP', bg='gray', fg='gray12', font=('Georgia', 18, 'bold'),
