...
class student:
    def __init__(self, window):
        ...
        self.frame = Frame(self.window, bg='lightblue', width=700, height=400)

        self.label = Label(self.frame, text='Student User', bg='lightblue', font=('Georgia', 30, 'bold'))
        self.label.place(x=20, y=20, width=400, height=50)

        self.label_title = Label(self.frame, text='TITLE', bg='lightblue', font=('Georgia', 14, 'bold'))
        self.label_title.place(x=20, y=100, width=100, height=50)

        self.label_year = Label(self.frame, text='YEAR', bg='lightblue', font=('Georgia', 14, 'bold'))
        self.label_year.place(x=20, y=150, width=100, height=30)

        self.label_author = Label(self.frame, text='AUTHOR', bg='lightblue', font=('Georgia', 14, 'bold'))
        self.label_author.place(x=350, y=100, width=100, height=30)

        self.label_isbn = Label(self.frame, text='ISBN', bg='lightblue', font=('Georgia', 14, 'bold'))
        ...
        self.button_clear = Button(self.frame, text='Clear Fields', command=self.clear_command)
        self.button_clear.place(x=500, y=320, width=100, height=40)
